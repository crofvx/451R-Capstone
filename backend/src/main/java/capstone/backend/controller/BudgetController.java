...
public class BudgetController {
	...
	public ResponseEntity<Object> createBudget(
			@RequestHeader(name = "Authorization", required = false) String authHeader, @RequestBody Budget budget) {
		try {
	...
	public ResponseEntity<Budget> updateBudget(@PathVariable UUID id, @RequestBody Budget budgetDetails) {
		...
		return updatedBudget.map(budget -> new ResponseEntity<>(budget, HttpStatus.OK))
