      ...
      <Navbar className="h-16 shadow-lg" fluid rounded theme = {newNavbarTheme.navbar}>
        ...
        <div className="flex md:order-2">
          <Dropdown label="My Profile" dismissOnClick={false} arrowIcon={true} pill>
            <DropdownHeader className="top-7 bottom-36">
              <span className="block text-sm">PLACEHOLDER_NAME</span>
        ...
        <NavbarCollapse>
          <NavbarLink
            ...
            className={`relative text-base after:absolute after:left-0 after:bottom-0 after:h-[2.5px] after:bg-blue-600 after:transition-all after:duration-300 '${
